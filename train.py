...
def main():
    ...
    if gpus:
        ...
        # [REMOVED] mixed_precision.set_global_policy('mixed_float16')
        print("🔧 Training in default Float32 precision (Maximum Stability)")
    else:
    ...
    # Note: Removed dtype='float32' from output layer since the whole model is now float32
